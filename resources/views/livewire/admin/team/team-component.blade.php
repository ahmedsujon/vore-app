<div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Team Member</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-white" style="border-bottom: 1px solid #e2e2e7;">
                            <h4 class="card-title" style="float: left;">All Team Member</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    ...
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button
                                                            ...
                                                            wire:click.prevent='editData({{ $team->id }})'
                                                        ...
                                                        <button
                                                            ...
                                                            wire:click.prevent='deleteConfirmation({{ $team->id }})'
                                                            wire:loading.attr='disabled'>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="7" class="text-center pt-5 pb-5">No team member found!</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
                        ...
                        <div class="card-footer bg-transparent">
                            {{ $teams->links('livewire.pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: white;">
                    <h5 class="modal-title m-0" id="mySmallModalLabel">Add New Team Member</h5>
                        ...
                        <div class="col-md-11">
                            <form wire:submit.prevent='storeData' enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="example-number-input" class="col-form-label">Designation</label>
                                        <input class="form-control mb-2" type="text" wire:model="designation"
                                ...
                                <div class="mb-3 row mt-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light w-50">
                                            {!! loadingStateWithText('storeData', 'Add Team Member') !!}
                                        </button>
                                    </div>
                                </div>
                            </form>
    ...
    <div wire:ignore.self class="modal fade" id="editDataModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: white;">
                    <h5 class="modal-title m-0" id="mySmallModalLabel">Edit Team Member</h5>
                        ...
                        <div class="col-md-11">
                            <form wire:submit.prevent='updateData'>
                                ...
                                <div class="mb-3 row mt-4">
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light w-50">
                                            {!! loadingStateWithText('updateData', 'Update Team Member') !!}
                                        </button>
                                    </div>
                                </div>
                            </form>

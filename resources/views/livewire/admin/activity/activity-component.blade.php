                ...
                <div class="col-lg-12">
                    <div class="card">
                                ...
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle">Default Calory</th>
                                    ...
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 15%;">
                                                        @if ($activity->status == 0)
                                                            <span class="btn btn-xs btn-warning"
                                                                style="font-weight: normal; font-size: 11px; padding: 1px 7px;">In
                                                                Active</span>
                                                        @else
                                                            <span class="btn btn-xs btn-success"
                                                                style="font-weight: normal; font-size: 11px; padding: 1px 7px;">Active</span>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <button
                                                            ...
                                                            wire:click.prevent='deleteConfirmation({{ $activity->id }})'
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="7" class="text-center pt-5 pb-5">No activities found!
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
                        ...
                        <div class="card-footer bg-transparent">
                            {{ $activities->links('livewire.pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        window.addEventListener('activity_deleted', event => {

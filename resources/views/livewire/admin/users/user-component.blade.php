                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-white" style="border-bottom: 1px solid #e2e2e7;">
                            <h4 class="card-title" style="float: left;">All User</h4>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="align-middle">Goal</th>
                                            <th class="align-middle">Daily Activity Level</th>
                                    ...
                                    <tbody>
                                        @if ($users->count() > 0)
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>{{ $user->gender }}</td>
                                                    <td>{{ $user->goal }}</td>
                                                    <td>{{ $user->daily_activity_level }}</td>
                                                    <td>{{ $user->height }}</td>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="7" class="text-center pt-5 pb-5">No users found!</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>

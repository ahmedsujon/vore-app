<div>
    <main>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hero_content_area" data-aos="fade-up">
                            ...
                            <a href="#" class="default_btn"> <span>Get started</span> </a>
                            <div class="avaiable_area">
                                <h4>Available on</h4>
                                <div class="app_area d-flex align-items-center flex-wrap">
                                    <a href="https://apps.apple.com/nz/app/vore/id6480172276" target="_blank">
                                        <img src="{{ asset('assets/app/icons/app_store.png') }}" alt="app store icon" />
                                    </a>
                                    <a href="https://play.google.com/store/apps/details?id=com.vore.app.vore&hl=en&gl=US"
                                        target="_blank">
        ...
        <section class="work_goal_wrapper default_section_gap"
            style="
            background-image: url({{ asset('assets/app/images/home/work_goal_background.png') }});
          ">
            <div class="container">
